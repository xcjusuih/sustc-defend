...
namespace TowerDefence
{
    ...
    {
        private const string DataRowClassPrefixName = "TowerDefence.DR";
        ...
        public static bool HaveDataTable(this DataTableComponent dataTableComponent, string dataTableName, object userData)
        {
            if (string.IsNullOrEmpty(dataTableName))
            {
                Log.Warning("Data table name is invalid.");
            ...
            string name = splitedNames.Length > 1 ? splitedNames[1] : null;
            return dataTableComponent.HasDataTable(dataRowType);
        }
